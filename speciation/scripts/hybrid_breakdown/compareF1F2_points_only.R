...
data_phen <- read_csv("data/phenotypes_n[2]_N[1000]_alpha[0.01, 0.025, 0.075, 0.1]_u[0.001]_sigma[1]_opt_dist[1]_dom[9, 0.5].csv")
...
ggplot(fit_trial, aes(x = factor(angle), y = hybrid_breakdown, color = factor(h))) +
  geom_boxplot()
